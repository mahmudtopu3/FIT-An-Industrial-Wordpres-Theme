...
-->
            ...
            <div class="row">
                <div class="col-md-12 ">
                    ...
                    <div class="text center">
                        ...
                        <h3 class="text-center mobile-slogan">Proudly We Worked With</h3>
        ...
        <div class="events-w3l" id="news">
            <div class="container">
                <div class="team-w3l">
                    <h3 class="w3_tittle">Our Impressions</h3>
                </div>
			       ...
			       <?php while ( $item ->have_posts() ) :$item -> the_post(); ?> 
                    <div class="col-md-4 col-sm-4 w3l-event-grid">
                       <br>
                        ...
                        <div class="text-w3">
						<a href="<?php the_permalink();?>" class="rew3" ><h5><?php the_title();?></h5></a>
